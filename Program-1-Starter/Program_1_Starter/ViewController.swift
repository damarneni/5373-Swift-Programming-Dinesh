...
class ViewController: UIViewController {
    ...
    func matchColorLogic() -> Bool{
        ...
        while Answer2.colorName == Answer1.colorName {
            Answer2 = self.myColors.fetchRandomColor()
        }
        
        var Answer3 = self.myColors.fetchRandomColor()
        ...
        if(buttonAnswer == 0){
            btnAnswer1OUTLET.setTitle(Answer1.colorName, forState: UIControlState.Normal)
            btnAnswer2OUTLET.setTitle(Answer2.colorName, forState: UIControlState.Normal)
        ...
        if(buttonAnswer == 2){
            ...
            btnAnswer2OUTLET.setTitle(Answer2.colorName, forState: UIControlState.Normal)
            btnAnswer3OUTLET.setTitle(Answer1.colorName, forState: UIControlState.Normal)
            button3Correct = true
        }
    ...
    func changeColor() -> Bool{
        ...
        if(colorNumber == 0){
            ...
            lblChangeColor.backgroundColor = UIColorFromRGB(0xFF1493)
        }
        if(colorNumber == 1){
